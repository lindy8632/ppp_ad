...
import com.example.ylfcf.widget.XRefreshView.XRefreshViewListener;
import com.example.ylfcf.widget.XWebView;
...
//                        addFooterView(true);
    ...
    private static final String RECYCLERVIEW_ADAPTER_WARIN = "";
