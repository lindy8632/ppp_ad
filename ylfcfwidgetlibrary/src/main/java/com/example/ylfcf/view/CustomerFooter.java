...
public class CustomerFooter extends LinearLayout implements IFooterCallBack {
    ...
    public void callWhenNotAutoLoadMore(final XRefreshView xRefreshView) {
        ...
        mClickView.setText(getResources().getString(R.string.xrefreshview_footer_hint_click));
    ...
    public void onReleaseToLoadMore() {
        ...
        mProgressBar.setVisibility(View.GONE);
        mClickView.setVisibility(View.VISIBLE);
        mClickView.setText(getResources().getString(R.string.xrefreshview_footer_hint_release));
    }

    @Override
    public void onStateFinish(boolean hideFooter) {
        if (hideFooter) {
            mHintView.setText(getResources().getString(R.string.xrefreshview_footer_hint_normal));
        } else {
            //处理数据加载失败时ui显示的逻辑，也可以不处理，看自己的需求
            mHintView.setText(getResources().getString(R.string.xrefreshview_footer_hint_fail));
        }
    ...
    public void onStateComplete() {
        mHintView.setText(getResources().getString(R.string.xrefreshview_footer_hint_complete));
        mHintView.setVisibility(View.VISIBLE);
        mProgressBar.setVisibility(View.GONE);
        show(true);
    }
