package com.ylfcf.ppp.viewflow;
...
public class ViewFlow extends AdapterView<Adapter> {
	...
	private void logBuffer() {
		/*
		 * if(StarUtil.DEBUG) Log.d("viewflow", "Size of mLoadedViews: " +
		 * mLoadedViews.size() + ", Size of mRecycledViews: " +
		 * mRecycledViews.size() + ", X: " + mScroller.getCurrX() + ", Y: " +
		 * mScroller.getCurrY()); if(StarUtil.DEBUG) Log.d("viewflow",
		 * "IndexInAdapter: " + mCurrentAdapterIndex + ", IndexInBuffer: " +
		 * mCurrentBufferIndex);
		 */
	}
}
