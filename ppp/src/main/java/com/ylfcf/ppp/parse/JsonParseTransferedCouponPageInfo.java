...
public class JsonParseTransferedCouponPageInfo {
    ...
    private void parsePageInfo(String data) throws Exception{
    ...
    public static BaseInfo parseData(String result) throws Exception {
        JsonParseTransferedCouponPageInfo jsonParse = new JsonParseTransferedCouponPageInfo();
