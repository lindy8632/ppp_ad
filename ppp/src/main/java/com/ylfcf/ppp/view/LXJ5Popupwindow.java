...
public class LXJ5Popupwindow extends PopupWindow implements View.OnClickListener {
    private ImageView deleteImg;
    private ImageView contentImg;
    private Activity context;
    private WindowManager.LayoutParams lp = null;

    public LXJ5Popupwindow(Context context) {
        super(context);
    }

    public LXJ5Popupwindow(Context context, View convertView,
    ...
    private void findViews(View popView) {
        ...
        contentImg.setBackgroundResource(R.drawable.lxj5_first_bg);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.lxfx_popwindow_main_content:
                Intent intentBanner = new Intent(context, LXJ5TempActivity.class);
