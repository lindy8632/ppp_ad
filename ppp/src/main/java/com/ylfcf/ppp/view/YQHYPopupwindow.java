 ...
 *
 */
public class YQHYPopupwindow extends PopupWindow implements OnClickListener{
	private ImageView deleteImg;
	private ImageView contentImg;
	private Activity context;
	private WindowManager.LayoutParams lp = null;

	public YQHYPopupwindow(Context context) {
		super(context);
	}

	public YQHYPopupwindow(Context context, View convertView,
	...
	private void findViews(View popView) {
		...
		contentImg.setBackgroundResource(R.drawable.yqhy_first_bg);
	...
	public void onClick(View v) {
		...
		case R.id.lxfx_popwindow_main_content:
			Intent intentBanner = new Intent(context,YQHYTempActivity.class);
