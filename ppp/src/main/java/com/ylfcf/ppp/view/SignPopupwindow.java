...
public class SignPopupwindow extends PopupWindow implements OnClickListener{
	...
	public SignPopupwindow(Context context, View convertView,
	...
	private void findViews(View popView) {
		...
		contentImg.setBackgroundResource(R.drawable.sign_first_bg);
	...
	public void onClick(View v) {
		...
		case R.id.lxfx_popwindow_main_content:
			Intent intentBanner = new Intent(context,SignTopicTempActivity.class);
