 ...
 * 
 */
public class AsyncExtensionPageInfo extends AsyncTaskBase {
	...
	public AsyncExtensionPageInfo(Context context, String userId,
	...
	protected String doInBackground(String... params) {
		...
		String result = null;
		try {
			url = URLGenerator.getInstance().getExtensionIncomeURL(userId,
					pageNo, pageSize);
			if (result == null) {
			...
			if (result == null) {
				...
				baseInfo = JsonParseExtensionPageInfo.parseData(result);
			}
		} catch (Exception e) {
			e.printStackTrace();
