 ...
 *
 */
public class AsyncInvestSRZXRecord extends AsyncTaskBase {
	...
	public AsyncInvestSRZXRecord(Context context, String investUserId,
	...
	protected String doInBackground(String... params) {
		...
		try {
			url = URLGenerator.getInstance()
					.getAppointBorrowInvestRecord(investUserId, borrowId, String.valueOf(pageNo), String.valueOf(pageSize));
			if (result == null) {
