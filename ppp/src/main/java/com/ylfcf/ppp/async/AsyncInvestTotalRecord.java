 ...
 * 
 */
public class AsyncInvestTotalRecord extends AsyncTaskBase {
	...
	public AsyncInvestTotalRecord(Context context, String investUserId,
	...
	protected String doInBackground(String... params) {
		...
		try {
			url = URLGenerator.getInstance()
					.getBorrowInvestSelectListAndTotalURL(investUserId,
							borrowId, status, pageNo, pageSize);
			if (result == null) {
