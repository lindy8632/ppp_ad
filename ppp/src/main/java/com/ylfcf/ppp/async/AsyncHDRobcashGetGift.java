...
public class AsyncHDRobcashGetGift extends AsyncTaskBase {
    ...
    public AsyncHDRobcashGetGift(Context context, String userId,
    ...
    protected String doInBackground(String... params) {
        ...
        String result = null;
        try {
            url = URLGenerator.getInstance().getHDRobCashGetGiftURL(userId);
