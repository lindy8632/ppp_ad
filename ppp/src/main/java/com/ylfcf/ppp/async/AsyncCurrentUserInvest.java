...
/**
 * 判断当前用户是否投资过该标的（定期理财产品）
 * @author Administrator
 *
 */
public class AsyncCurrentUserInvest extends AsyncTaskBase{
	...
	public AsyncCurrentUserInvest(Context context, String investUserId,String borrowId,
	...
	protected String doInBackground(String... params) {
		...
		String result = null;
		try {
			url = URLGenerator.getInstance().getCurrentUserInvestURL(investUserId, borrowId);
			if (result == null) {
