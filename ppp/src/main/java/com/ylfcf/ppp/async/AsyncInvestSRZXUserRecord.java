 ...
 *
 */
public class AsyncInvestSRZXUserRecord extends AsyncTaskBase{
	...
	public AsyncInvestSRZXUserRecord(Context context, String investUserId,
	...
	protected String doInBackground(String... params) {
		...
		try {
			url = URLGenerator.getInstance()
					.getAppointBorrowInvestUserRecord(investUserId, String.valueOf(pageNo), String.valueOf(pageSize));
			if (result == null) {
