 ...
 *
 */
public class AsyncYYYCurrentUserInvest extends AsyncTaskBase{
	...
	public AsyncYYYCurrentUserInvest(Context context, String investUserId,String borrowId,
	...
	protected String doInBackground(String... params) {
		...
		String result = null;
		try {
			url = URLGenerator.getInstance().getYYYCurrentUserInvestURL(investUserId, borrowId);
			if (result == null) {
