...
public class CycleViewPager extends Fragment implements OnPageChangeListener{
	...
	private void findViews(View view, LayoutInflater inflater){
		viewPager = (BaseViewPager) view.findViewById(R.id.view_cycle_viewPager);
		indicatorLayout = (LinearLayout) view
				.findViewById(R.id.view_cycle_viewpager_content_indicator);
	...
	public void setParentView(ViewGroup viewG){
		if(viewPager != null){
			viewPager.setParent(viewG);
		}
	}
	...
	public void setData(List<ImageView> views, List<BannerInfo> list, ImageCycleViewListener listener, int showPosition) {
		...
		for (int i = 0; i < indicators.length; i++) {
			...
			indicators[i] = (ImageView) view.findViewById(R.id.view_cycle_viewpager_image_indicator);
