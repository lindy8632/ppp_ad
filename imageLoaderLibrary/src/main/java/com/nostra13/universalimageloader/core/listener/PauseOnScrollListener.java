...
public class PauseOnScrollListener implements OnScrollListener {
	...
	private final boolean delayOnResum;
	...
	private Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			case 0:
				imageLoader.resume();
				System.out.println("OnScrollListener.SCROLL_STATE_IDLE---");
				break;
	...
	public PauseOnScrollListener(ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling,
		...
		this(imageLoader, pauseOnScroll, pauseOnFling, false, customListener);
	}
	
	public PauseOnScrollListener(ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling,
			boolean delayOnResum,
			OnScrollListener customListener) {
		this.imageLoader = imageLoader;
		this.pauseOnScroll = pauseOnScroll;
		this.pauseOnFling = pauseOnFling;
		this.delayOnResum = delayOnResum;
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		switch (scrollState) {
			...
			case OnScrollListener.SCROLL_STATE_TOUCH_SCROLL:
				if (pauseOnScroll) {
					imageLoader.pause();
					System.out.println("OnScrollListener.SCROLL_STATE_TOUCH_SCROLL---");
				}
				break;
			case OnScrollListener.SCROLL_STATE_FLING:
				if (pauseOnFling) {
					imageLoader.pause();
					System.out.println("OnScrollListener.SCROLL_STATE_FLING---");
				}
				break;
		}
